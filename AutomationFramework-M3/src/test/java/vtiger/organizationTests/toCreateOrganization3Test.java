...
//scenario 3
public class toCreateOrganization3Test extends BaseClass {
	@Test
	public void tocreateOrganization_003() throws Exception {
		...
		Reporter.log("Create organization page successfully", true);
		...
		wUtil.handleDropdown(cop.getIndustryDropdown(), "Chemicals");
